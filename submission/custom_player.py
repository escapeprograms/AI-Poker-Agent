...
class CustomPlayer(CFRDPlayer):
    ...
    # model_path = os.path.join(os.path.dirname(__file__), "../models/CFR-D_cp7.pth")
    evaluation_function.load_state_dict(torch.load("submission/models/CFR-D_cp7.pth", weights_only=True))  
    def __init__(self):
