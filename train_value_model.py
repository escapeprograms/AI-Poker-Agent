...
def train_loop(hole_suit, hole_rank, hole_card_idx, board_suit, board_rank, board_card_idx, actions_occured, bet_sizes, values, model, num_epochs=30, batch_size=1):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
